...
class BaseDataset(torch.utils.data.Dataset):
    ...
    def get_img_by_path(self, img_path):
        # print(os.getcwd())
        # print(os.path.isdir("dataset_new2"))
        # print(os.path.isfile(img_path))
        # print(os.path.isfile("dataset_new2/emotionNet/imgs/sudhir.jpg"))
        ...
        # for i in img_path:
        #     print("this is '" + i + "'")
        # print(len("dataset_new2/emotionNet/imgs/sudhir.jpg"))
        # print(img_path == "dataset_new2/emotionNet/imgs/sudhir.jpg")
        # print(os.path.isfile(os.path.join(os.getcwd(), img_path)))
        # print(img_path)
        # print(img_path)
